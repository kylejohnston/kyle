...
<head>
	...
	@media (min-width: 1012px) {
		.overlap{margin-bottom:-200px;padding-top:56px;transform:translateY(-200px);}
		.overlap--content{background:white;}
	}
	</style>
</head>
...
<body>
	...
	<article class="content">
		...
		<section class="block block--wide">
				<div class="col-4 shim overlap"></div>
				<div class="col-7 overlap overlap--content">
					<div class="block">
						...
						<div class="col-11">
							<div class="inner">
								...
								<p><a href="/files/kyle-johnston-creative-leader-designer-2018.pdf">Download my complete resume</a> and learn more about my career.</p>
							</div>
						</div>
					</div>
				</div>
				<div class="col-1 overlap shim"></div>
		</section>
		...
		<section class="block">
			<div class="col-1 shim"></div>
			<h2 class="col-11"><div class="inner">Speaking &amp; Writing</div></h2>
			<div class="col-1 shim"></div>
			<div class="col-5">
				<div class="inner">
					<h3>Speaking</h3>
		...
		<section class="block">
			<div class="col-1 shim"></div>
			<h2 class="col-11"><div class="inner">Professional Organizations &amp; Awards</div></h2>
			<div class="col-1 shim"></div>
			<div class="col-5">
				<div class="inner">
