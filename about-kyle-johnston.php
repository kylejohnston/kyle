...
<head>
	...
	<style type="text/css">
			html {
			background: hsl(207, 68%, 33%);
			background: linear-gradient(180deg, hsl(207, 68%, 33%) 0%, hsl(207, 68%, 27%) 35%);
		}
...
<body>
	...
	<article class="content">
		<section class="block">
			<div class="col-10">
				<img class="spacer-5--bottom rounders" src="/img/kyle-johnston.jpg" alt="Kyle Johnston">
				<h1>About Me</h1>
		...
		<section class="block">
			<h2 class="col-12">Speaking &amp; Writing</h2>
			<div class="col-5">
				<h3>Speaking</h3>
		...
		<section class="block">
			<h2 class="col-12">Professional Organizations &amp; Awards</h2>
			<div class="col-5">
