...
<head>
	...
	<style type="text/css">
		html {
			background: hsl(156,100%,25%);
			background: linear-gradient(180deg, hsl(156,100%,25%) 0%, hsl(156,100%,21%) 35%);
		}
...
<body>
	...
	<article class="content">
		...
		<section class="block">
			<div class="pattern__3-6-3" data-aos="fade-up">
		...
		<section class="block">
			...
			<div class="col-6 caption" data-aos="fade-up">
				<img class="shadow" src="/img/samples/waddell/waddell-homepage.920.jpg" alt="Waddell & Reed - The New Homepage" width="100%">
				<p>The new homepage</p>
			</div>
			<div class="col-6 caption" data-aos="fade-up" data-aos-delay="200">
				<img class="shadow" src="/img/samples/waddell/waddell-find-advisor.jpg" alt="Waddell & Reed - Find an Advisor page" width="100%">
