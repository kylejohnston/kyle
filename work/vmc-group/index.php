...
<head>
	<meta charset="utf-8">
	<title>Portfolio: VMC Group Website Redesign | Kyle W. Johnston</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<meta name="description" content="Kyle Johnston Work Sample: VMC Group Website Redesign" />
	<meta name="keywords" content="portfolio, kyle johnston, logo design, app design, user experience" />
	<meta name="author" content="Kyle Johnston" />
	<link href="https://plus.google.com/103758963959064535451" rel="publisher" />
	<link href="http://www.kylewjohnston.com/work/vmc-group/" rel="canonical" />
	<?php include($_SERVER['DOCUMENT_ROOT'] . '/includes/head.php'); ?>
	<style type="text/css">
		html,article.content::before {background: #111;}
...
<body>
	...
	<section class="block">
		...
		<div class="col-6 spacer-6 intro">
			<div class="inner">
				...
				<p>As a 120-year-old brand, VMC Group is a recognized world leader in the design and manufacture of vibration isolation, seismic control and shock protection products.</p>
				<p>They wanted to redesign their website to better reflect the growth and maturity of the company and provide a more well-rounded and engaging experience for prospective and existing customers.</p>
				<p><strong>Credits:</strong><br>
				<strong>My Role:</strong> IA, UX, Visual Design<br>
				<strong>InQuest Marketing:</strong> Development, Copywriting, Project and Account Management</p>
			</div>
		</div>
	...
	<article class="content">
		...
		<section class="block block--narrow spacer-6">
			...
			<div class="col-6">
				<div class="inner">
					<h3>Concepts and Wireframes</h3>
					<p>With a solid foundation for the structure of the site, I designed a range of homepage concepts and page wireframes, which I presented to the CEO.</p>
				</div>
			</div>
			<div class="col-3 shim"></div>
			<div class="col-12">
		...
		<section class="block spacer-6">
			...
			<div class="col-6">
				<div class="inner">
					<h3>Visual Design</h3>
					<p>Once a visual direction was selected, I designed desktop and mobile-optimized versions for each page of the website. I also designed a style guide which allowed the developer to start building the site while pages were being reviewed and approved by the client.</p>
				</div>
			</div>
			<div class="col-3 shim"></div>
			...
			<div class="col-7">
				<div class="inner">
					<p><strong>Product Page, Desktop</strong></p>
					<div class="screen-demo rounders shadow-lg">
						<div></div>
						<picture>
		...
		<section class="block spacer-6">
			...
			<div class="col-7">
				<div class="inner">
					<p><strong>Services, Desktop</strong></p>
					<div class="screen-demo rounders shadow-lg">
						<div></div>
						<picture>
		...
		<section class="block spacer-6">
			...
			<div class="col-7">
				<div class="inner">
					<p><strong>Company, Desktop</strong></p>
					<div class="screen-demo rounders shadow-lg">
						<div></div>
						<picture>
