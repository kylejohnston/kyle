...
<head>
	<meta charset="utf-8">
	<title>Portfolio: Right Triangle Branding and Design | Kyle W. Johnston</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<meta name="description" content="Kyle Johnston Work Sample: Right Triangle Branding and Design" />
	<meta name="keywords" content="portfolio, kyle johnston, logo design, app design, user experience" />
	<meta name="author" content="Kyle Johnston" />
	<link href="https://plus.google.com/103758963959064535451" rel="publisher" />
	<link href="http://www.kylewjohnston.com/work/right-triangle/" rel="canonical" />
	<?php include($_SERVER['DOCUMENT_ROOT'] . '/includes/head.php'); ?>
	<style type="text/css">
		html,article.content::before {background: #38A349;}
		.hnote{display:block;padding:0;font-size:72%;color:#AFB3B5}
		h1,h2,h3{color:#38A349;}
	</style>
</head>
	...
	<section class="block">
		...
		<div class="col-6 spacer-6 intro">
			<div class="inner">
				...
				<p>Right Triangle Consulting specializes in modernizing data architecture for growing organizations. They wanted to update their brand identity and website to fuel their growth and enhance their reputation as data experts with both clients and partners.</p>
				<p>From a new logo and website to presentations and email templates, I created a robust, modern brand identity that helps Right Triangle stand out in a crowded market and positions them for growth.</p>
			</div>
		</div>
	...
	<article class="content">
		<section class="block block--narrow spacer-9--top">
			<div class="pattern__3-6-3">
				<h2><span class="hnote">The Process</span>Brand Sprint</h2>
				<p>We kicked off the project with a <a href="https://library.gv.com/the-three-hour-brand-sprint-3ccabf4b768a" title="What's a brand sprint?">brand sprint</a>. This helped define Right Triangle’s ‘why’, brand values, and more.</p>
			</div>
		</section>
		<section class="block block--narrow">
			...
			<div class="col-10">
				<picture class="">
          <source srcset="/img/samples/right-triangle/brand-sprint.lg.webp" media="(min-width: 50em)" type="image/webp">
          <source srcset="/img/samples/right-triangle/brand-sprint.lg.png" media="(min-width: 50em)">
		...
		<section class="block block--narrow spacer-6">
			<div class="pattern__3-6-3">
				<h2>Logo Design</h2>
				<p>In the design phase, I thoroughly researched the market and focused on designing a brand identity and logo design that distinguishes Right Triangle from their competition.</p>
			</div>
			<div class="col-6">
				<picture class="">
		...
		<section class="block block--narrow spacer-6">
			<div class="col-5">
				<div class="inner" style="position:sticky;top:48px;">
					<h2>Website Redesign</h2>
					<p>The new <a href="https://https://right-triangle.com/" title="Right Triangle website">Right Triangle website</a> focuses on quickly and dynamically communicating Right Triangle's passion for ‘data done right’ and driving visitors to act.</p>
				</div>
			</div>
			<div class="col-1 shim"></div>
			<div class="col-6">
		...
		<section class="block block--narrow spacer-6">
			...
			<div class="col-6">
				...
				<p class="caption">Business Card Design</p>
			</div>
			<div class="col-6">
				<picture class="img">
				...
				<p class="caption">Presentation Template Design</p>
			</div>
			<div class="col-6">
				<picture class="img">
