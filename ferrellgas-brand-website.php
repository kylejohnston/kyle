...
<head>
	...
	<style type="text/css">
		html {
			...
			background: linear-gradient(180deg, hsl(205,100%,30%) 0%, hsl(205,100%,26%) 35%);
		}
...
<body>
	...
	<article class="content">
		...
		<section class="block">
			<div class="col-12"><div class="inside"><h3>A few slides from our workshop…</h3></div></div>
			<div class="col-4 caption" data-aos="fade-up">
			...
			<div class="col-4 caption" data-aos="fade-up" data-aos-delay="200">
			...
			<div class="col-4 caption" data-aos="fade-up" data-aos-delay="500">
			...
			<div class="col-4 caption" data-aos="fade-up" data-aos-delay="800">
