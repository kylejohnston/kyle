...
<head>
	...
	<style type="text/css">
		...
		article.content{background:white url('/img/angle--amc.svg') left -1px no-repeat;
background-size:101%}
	</style>
</head>
	...
	<section class="block">
		...
		<div class="col-6 spacer-6 intro">
			<div class="inner">
				...
				<p><strong>Contributions:</strong> Creative Direction, Creative Strategy, Design</p>
			</div>
		</div>
