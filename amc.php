...
<head>
	<meta charset="utf-8">
	<title>Portfolio: AMC Theatres New Business Pitch | Kyle W. Johnston</title>
	<meta name="viewport" content="width=device-width, initial-scale=1.0" />
	<meta name="description" content="Kyle Johnston Work Sample: AMC new business pitch" />
...
<body>
		...
		<div class="container">
			<div class="row">
				<div class="introduction">
					<h1>AMC New Business Pitch</h1>
					<p>While at DEG In 2016, I joined forces with our senior sales director, senior email strategist, and other key team members to pitch, and eventually win, email marketing services for AMC Theatres. We won the business &#8211; one of the largest such accounts in the history of the agency &#8211; by showcasing our capabilities and ingenuity, with a healthy dose of hospitality.</p>
	...
	<div class="container marketing">
		<div class="featurette">
			<div class="container">
				<div class="row nudge-bottom--lg">
					<div class="span12">
						<div class="inner">
							<h2>Illustrating the Customer Journey</h2>
							<img class="" src="//www.kylewjohnston.com/img/samples/amc/amc-customer-journey.full.png" alt="AMC Customer Journey">
						</div>
					</div>
				</div>
				<div class="row">
					...
					<div class="span7">
						<div class="inner">
							<div class="caption">
								<img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/amc-journey-presentation.920.jpg" alt="AMC Customer Journey">
			...
			<div class="container">
				<div class="row clear">
					...
					<div class="span6">
						<div class="inner">
							<div class="caption">
								<img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-001.920.jpg" alt="AMC pitch deck examples">
							</div>
						</div>
					</div>
				</div>
				<div class="row clear">
					<div class="span4">
						<div class="inner">
							<div class="caption">
								<div class="nudge-bottom--sm"><img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-002.600.jpg" alt="Persona example"></div>
								<img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-003.600.jpg" alt="Persona example">
					...
					<div class="span8">
						<div class="inner">
							<div class="caption">
								<img class="shadow " src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-004.920.jpg" alt="Onboarding flow example">
				...
				<div class="row clear">
					<div class="span6">
						<div class="inner">
							<h3>Illustrating the Steps</h3>
							<p>At key steps in the journey, we illustrated the personalized messages we could send based on a range of available data, including AMC Stubs membership status, purchase history, and more.</p>
						</div>
					</div>
					<div class="span6">
						<div class="inner">
							<div class="caption">
								<img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-005.920.jpg" alt="Onboarding step example">
							</div>
						</div>
					</div>
				</div>
				<div class="row clear">
					<div class="span6">
						<div class="inner">
							...
							<img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-006.920.jpg" alt="Research results">
						</div>
					</div>
					<div class="span6">
						<div class="inner">
							<div class="shadow nudge-bottom--sm"><img src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-007.920.jpg" alt="Component examples"></div>
							<img class="shadow" src="//www.kylewjohnston.com/img/samples/amc/pitch-deck-sample-008.920.jpg" alt="Newsletter matrix">
						</div>
					</div>
				</div>
			</div>
